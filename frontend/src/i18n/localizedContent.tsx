...
export const localizedContent = {
  zh: {
    ...
    ai: {
      ...
      continueRecommendedYes: '建议继续',
      continueRecommendedNo: '先补充信息',
      keyDifferences: '主要差异',
      riskNotes: '风险说明',
    ...
    matching: {
      ...
      receiptSummary: '收货情况',
      invoiceSummary: '开票情况',
      receiptDocumentSingular: '张收货单',
      receiptDocumentPlural: '张收货单',
      invoiceDocumentSingular: '张发票',
      invoiceDocumentPlural: '张发票',
      receivedQuantityLabel: '已收货',
      invoicedQuantityLabel: '已开票',
      missingReceipt: '缺收货',
      missingInvoice: '缺发票',
      receiptShort: '收货不足',
  ...
  en: {
    ...
    ai: {
      ...
      continueRecommendedYes: 'Continue',
      continueRecommendedNo: 'Add Info First',
    ...
    matching: {
      ...
      invoiced: 'Invoiced',
      lastCalculated: 'Last Calculated',
      receiptSummary: 'Receiving',
      invoiceSummary: 'Invoicing',
      receiptDocumentSingular: 'receipt',
      receiptDocumentPlural: 'receipts',
      invoiceDocumentSingular: 'invoice',
      invoiceDocumentPlural: 'invoices',
      receivedQuantityLabel: 'received',
      invoicedQuantityLabel: 'invoiced',
