...
Define PO-based three-way matching for Fox Procureflow, including company-scoped matching results, deterministic difference detection, exception handling audit records, APIs, frontend workspace behavior, and boundaries that exclude deferred infrastructure, payment, upload, and AI workflows.
