...
Define the MVP RFQ capability so procurement users can create company-scoped RFQs from approved purchase requests, invite group-shared suppliers, capture quote metadata, and compare supplier responses without creating downstream procurement execution records.
